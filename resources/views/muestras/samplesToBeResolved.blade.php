...
@section('contenido')
    <div id="content" class="content">
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">Resolucion de muestras</li>
        </ol>
        <h1 class="page-header"><i class="fa fa-ellipsis-v"></i> Resolucion de muestras</h1>
        <div class="row">
            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-inline">
                                    ...
                                    <button type="button" id="btnBuscador" class="btn btn-success"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-6">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Muestras por resolucionar</h4>
                    </div>
                    <div class="panel-body">
                        @if($muestras->count() > 0)
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="alert alert-warning">
                                        <p>No hay muestras por resolucionar</p>
                                    </div>
                                </div>
                            </div>
                        @endif                    
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Mis muestras resolucionadas</h4>
                    </div>
                    <div class="panel-body">
                        @if($muestrasResolucionadas->count() > 0)
                            <div class="table-responsive">
                                <table class="table table-striped m-b-0">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        @foreach($muestrasResolucionadas as $muestra)
                                            <tr>
                                                <td><a href="{{ route('muestras.show', $muestra->id_muestra) }}">{{$muestra->id_muestra}}</a></td>
                                                <td>{{ $muestra->recepcion == null ? "Por recepcionar" : $muestra->recepcion}}</td>
                                                <td>{{$muestra->nombre_tipo_analisi}}</td>
                        ...
                        @else
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="alert alert-warning">
                                        <p>No tienes muestras resolucionadas</p>
                                    </div>
                                </div>
                            </div>
                        @endif                    
