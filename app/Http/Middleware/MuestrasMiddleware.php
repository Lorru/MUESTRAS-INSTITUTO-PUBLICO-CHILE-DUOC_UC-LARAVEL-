...
class MuestrasMiddleware
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        {
            if(Session::get('perfilUsuario') == $idPerfilRecepcion && Session::get('perfilUsuario') == $idPerfilResolucion && Session::get('estadoUsuario') == $estadoUsuario)
            {
