...
class MuestrasResolucionadasMiddleware
{
    /**
    ...
    public function handle($request, Closure $next)
    {
        ...
        {
            if(Session::get('perfilUsuario') == $idPerfilCliente && Session::get('perfilUsuario') == $idPerfilRecepcion && Session::get('estadoUsuario') == $estadoUsuario)
            {
